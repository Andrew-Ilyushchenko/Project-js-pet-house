...
const menuBody = document.querySelector('.navigation-wrap');
if(iconMenu){
    ...
    iconMenu.addEventListener("click", function(e){
        ...
        const listItem = document.querySelector('.navigation-list');
        listItem.classList.toggle('_active');
    });
}


const menuLinks = document.querySelectorAll('.navigation_a[data-goto]');
